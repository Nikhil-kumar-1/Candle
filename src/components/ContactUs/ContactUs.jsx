      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              <h2 className="text-2xl font-bold text-[#152336] mb-6">
                Send Us a Message
              </h2>
              ...
              <form className="space-y-6">
                ...
                >
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-sm font-medium text-[#152336]/80 mb-1"
                    >
                      Name
                    </label>
                    <input
            ...
            <motion.div variants={slideUp} className="space-y-8">
              ...
              >
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-[#152336] mb-1">
                      Email Us
                    </h3>
              ...
              >
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-[#152336]/90 mb-2">+91 9911755588</p>
              ...
              >
                <h3 className="text-lg font-bold text-[#f1ead8] mb-4">
                  Follow Us
                </h3>
                  ...
                  {[
                    {
                      ...
                      name: "Instagram",
                      link: "https://www.instagram.com/ravangicandles/",
                    },
                    {
                      icon: <FiFacebook size={24} />,
                      name: "Facebook",
                      link: "https://www.facebook.com/profile.php?id=61578351792220&notif_id=1754609099775378&notif_t=page_user_activity&ref=notif#",
                    },
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center z-10">
                <div className="text-center p-6 bg-white/90 backdrop-blur-sm rounded-lg shadow-md">
                  ...
                  <h3 className="text-xl font-bold text-[#152336]">
                    Our Location
                  </h3>
                  <p className="text-[#152336]/90 mt-2">
                    123 Fragrance Lane, Mumbai
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  ...
                  >
                    <span className="font-medium text-[#152336]">
                      {item.day}
                    </span>
              ...
              >
                <p className="text-[#152336]/90 italic">
                  "Our customer care team responds to all inquiries within 24
                  hours. For immediate assistance, please call us during
                  business hours."
                </p>
              </motion.div>
            </motion.div>
      ...
      <section className="py-16 bg-[#152336]">
        ...
        >
          ...
          <p className="text-lg text-[#f1ead8]/90 mb-8">
            Our fragrance experts are happy to help you find the perfect attar
            for any occasion.
          </p>
          <motion.button
