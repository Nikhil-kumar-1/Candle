...
import { FiShoppingBag, FiUser, FiFileText, FiAlertTriangle, FiDownload, FiMail } from "react-icons/fi";
  ...
  return (
    <div className="min-h-screen bg-[#fafaf1] font-poppins overflow-hidden">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative">
        {/* Background pattern */}
        <div className="absolute inset-0 opacity-[0.03] bg-repeat" style={{ backgroundImage: "url('data:image/svg+xml,%3Csvg width=\"20\" height=\"20\" viewBox=\"0 0 20 20\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Cpath d=\"M0 0h20v20H0z\" fill=\"none\"/%3E%3Cpath d=\"M1 1v18h18V1H1zm1 1h16v16H2V2zm2 2h12v12H4V4zm1 1v10h10V5H5z\" fill=\"%23000000\"/%3E%3C/svg%3E')" }}></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="flex cursor-pointer items-center space-x-4">
                  ...
                  <span className="text-sm opacity-80">Full document version available for download</span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <motion.button 
                  whileHover={{ scale: 1.03, boxShadow: "0 10px 25px -5px rgba(241, 234, 216, 0.2)" }}
                  whileTap={{ scale: 0.98 }}
