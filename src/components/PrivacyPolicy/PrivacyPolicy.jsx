...
const PrivacyPolicy = () => {
  ...
  const privacyPrinciples = [
    ...
    },
    {
      ...
      description:
        "We'll notify you of any significant changes to our policies",
    },
  ];
            ...
            {[
              {
                ...
                content:
                  "We collect information you provide directly, including name, email, shipping address, and payment details when you make a purchase. We also automatically collect certain information about your device and interaction with our website through cookies and similar technologies.",
              },
              {
                title: "How We Use Your Information",
                content:
                  "Your information is used to process transactions, communicate with you about orders, improve our services, and personalize your experience. We may also use aggregated data for analytics and marketing purposes.",
              },
              {
                title: "Data Sharing",
                content:
                  "We do not sell your personal information. We may share data with trusted third-party service providers who assist with payment processing, shipping, and marketing, all of whom are contractually obligated to protect your data.",
              },
              {
                title: "Your Rights",
                content:
                  "You have the right to access, correct, or delete your personal information. You may opt out of marketing communications at any time. For requests, please contact our privacy team using the information below.",
              },
              {
              ...
              },
              {
                ...
                content:
                  "We may update this policy periodically. We'll notify you of significant changes through email or a notice on our website. Your continued use of our services after such changes constitutes acceptance of the new policy.",
              },
            ].map((section, index) => (
              <motion.div
                key={index}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <div className="space-y-4">
                  <p>
                    <strong>Email:</strong> ravangicandles@gmail.com
                  </p>
                  <p>
                    <strong>Phone:</strong> +91 9911755588
                  </p>
                </div>
              </div>
              <div>
